"""LiveData panel for SVN (Service Node) miners.
...
class ServiceNodeTab(QtWidgets.QGroupBox):
    ...
    def __init__(self, title: str, doc_url: str, parent: Optional[QtWidgets.QWidget] = None):
    ...
    def _build_ui(self) -> None:
        ...
        try:
            ...
            pass
        layout.addWidget(self._title_label, 0, 0, 1, 1)
        ...
        self._learn_more_btn.clicked.connect(self._open_docs)
        ...
        # Add spacer row to push buttons down
    ...
    def _show_details(self) -> None:
        """Emit refresh signal when Details is clicked."""
...
class SvnPanel(QtWidgets.QWidget):
    """LiveData panel for SVN miners with tabbed Presearch and Diiisco panels."""
    ...
    def _build_ui(self) -> None:
        ...
        # Presearch tab
        self.presearch_panel = ServiceNodeTab("Presearch", PRESEARCH_DOC_URL)
        ...
        # Diiisco tab
        self.diiisco_panel = ServiceNodeTab("Diiisco", DIIISCO_DOC_URL)
    ...
    def update_presearch_status(self, status) -> None:
        ...
        self.presearch_panel.set_toggle_state(status.enabled)
    ...
    def update_diiisco_status(self, status) -> None:
        ...
        self.diiisco_panel.set_toggle_state(status.enabled)
