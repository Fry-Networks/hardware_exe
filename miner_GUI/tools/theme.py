"""FryNetworks desktop theme used by the GUI.

This restores the richer styling from the 6.3.0 release so tabs,
inputs, and panels keep the branded dark palette instead of Qt
defaults.
"""
